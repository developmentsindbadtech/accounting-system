...
<div class="px-4 py-5 sm:p-6">
    ...
    <div class="bg-white shadow sm:rounded-lg">
        <form action="{{ route('asset-categories.update', $category->id) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="number" name="depreciation_rate" id="depreciation_rate" step="0.01" min="0" max="100" value="{{ old('depreciation_rate', $category->depreciation_rate) }}"
