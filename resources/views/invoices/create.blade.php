...
<div class="px-4 py-5 sm:p-6">
    ...
    <div class="bg-white shadow sm:rounded-lg">
        <form action="{{ route('invoices.store') }}" method="POST" class="p-6" id="invoiceForm">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 mb-6">
                <div>
                    ...
                    <select name="customer_id" id="customer_id" required
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('customer_id') border-red-300 @enderror">
                ...
                <div>
                    ...
                    <input type="date" name="invoice_date" id="invoice_date" value="{{ old('invoice_date', date('Y-m-d')) }}" required
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('invoice_date') border-red-300 @enderror">
                    @error('invoice_date')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a href="{{ route('invoices.index') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50">
                    Cancel
                </a>
